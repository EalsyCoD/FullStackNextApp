describe('Login Component', () => {
  ...
  it('should display an error message for an incorrect username', () => {
    ...
    cy.get('.text-red-500').should('contain', 'Username must contain at least 6 characters');
  });
  ...
  it('should display an error message for an incorrect password', () => {
    ...
    cy.get('.text-red-500').should('contain', 'Password must contain at least 6 characters');
  });
  ...
  it('should display an error message for an incorrect password and username', () => {
    ...
    cy.get('.text-red-500').should('contain', 'Username required');
    cy.get('.text-red-500').should('contain', 'Password required');
  });
